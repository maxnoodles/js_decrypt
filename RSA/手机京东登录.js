...
function test(pwd){
    pK = ''
    setMaxDigits(131);
    var c = new RSAKeyPair("3","10001",pK,1024)
    , t = (encryptedString(c, pwd, RSAAPP.PKCS1Padding, RSAAPP.RawEncoding));
    return Buffer.from(t).toString('base64')
}

var username = '137512654824';
var pwd = 'a12345678'

console.log(test(username))
console.log(test(pwd))

var bat = CryptoJS.MD5('YGwTkAQs'.substr(0)+'kfKe8Gmz'.toUpperCase()+'HMSjVh+V'.toLowerCase()+'Z3csXx+J');
console.log(bat+'')
// t = new Buffer(t, 'base64')
